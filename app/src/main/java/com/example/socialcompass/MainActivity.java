...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        targetLocation1 = new Location("Home");
        targetLocation1.setLatitude(45.0819);
        targetLocation1.setLongitude(-73.3329);

        targetLocation2 = new Location("Parents");
        targetLocation2.setLatitude(20.0819);
        targetLocation2.setLongitude(-72.3329);

        targetLocation3 = new Location("Friend");
        targetLocation3.setLatitude(30.0819);
        targetLocation3.setLongitude(-50.3329);
    ...
    public static void updateUIMain(float angle1, TextView tv, int distance){
